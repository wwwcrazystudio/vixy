<template>
    <aside class="max-w-[72px] border-r flex flex-col border-gray p-2 md:p-4" @touchmove.stop>
        <ul class="list-none flex gap-3 flex-col">
            <GroupItem v-for="(group, key) in groups" :key="key" :group="group"
                :selected="selectedGroup.title === group.title" @click="handleGroupChange" />
            <li>
                <IconBtn @click="$emit('openConnectModal')">
                    <svg class="max-w-[80%]" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
