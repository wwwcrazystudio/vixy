<template>
    <div class="w-full flex flex-col">
        <div class="bg-white px-2 md:px-4 py-2 w-full flex flex-wrap items-center mb-auto">
            ...
            <div class="flex gap-2 items-center w-[40%] shrink grow">
            ...
            <div class="ml-auto gap-4 flex">
                <IconBtn transparent @click="videoHistoryModal = true">
                ...
                <IconBtn transparent @click="blacklistUserModal = true">
                    <svg class="max-w-[80%]" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <IconBtn transparent @click="transferUserModal = true">
                    <svg class="max-w-[80%]" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                            <path
        ...
        <form class="bg-white border-t border-gray py-2 px-4">
            <div class="relative flex items-center">
                ...
                <button class="ml-4 w-10 h-10 basis-10 rounded-full bg-accent text-white hover:bg-[#3053F4] active:bg-[#1433C2] grid place-content-center disabled:cursor-not-allowed disabled:opacity-60 transition"
        ...
        <Overlay v-if="transferUserModal">
            <TransferModal @close="transferUserModal = false" />
        </Overlay>
